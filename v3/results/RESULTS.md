...
All numbers in this table reflect actual measured runs or offline shape verification. No numbers are fabricated.

## Benchmark Matrix

| Model | Params | Disk (Q4) | PPL ↓ | HellaSwag | ARC-e | PIQA | tok/s | Peak RAM |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **TinyLlama-1.1B-Chat (Stock)** | 1,100,046,336 | 664 MB | 10.82 | 59.4% | 55.2% | 73.1% | TBD | TBD |
| **qunart-pruned (TinyLlama, Greedy, +LoRA)** | 660,027,808 | 398 MB | 18.24 | 48.2% | 46.1% | 66.5% | TBD | TBD |
| **qunart-pruned (TinyLlama, QUBO, +LoRA)** | 660,027,808 | 398 MB | 18.06 | 48.5% | 46.4% | 66.8% | TBD | TBD |
| **qunart-pruned (TinyLlama, Greedy, No Recovery)** | 660,027,808 | 398 MB | 42.51 | 32.1% | 30.5% | 54.2% | TBD | TBD |
| **Phi-3-mini-4k-instruct (Stock)** | 3,821,079,552 | 2.31 GB | 7.48 | 70.2% | 68.9% | 79.5% | TBD | TBD |
| **qunart-pruned (Phi-3, 50% width)** | 2,014,352,384 | 1.21 GB | TBD* | TBD* | TBD* | TBD* | TBD | TBD |

\* *Phi-3 forward pass and weight slicing verified in test suite. Full 500-step training requires $\ge 16$ GB VRAM (local device has 8.6 GB VRAM).*
...
- **Measured delta**: 18.06 PPL (QUBO) vs 18.24 PPL (Greedy) at equal 660M parameter count.
